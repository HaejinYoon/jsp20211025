			...
			<div class="col">
				...
				<input type="hidden" name="index" value="${index }">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="input2" name="contactName" value="${supp.contactName}">
					</div>
					<div class="form-group">
						<label for="input3">Address</label>
						<input type="text" class="form-control" id="input3" name="address" value="${supp.address}">
					</div>
					<div class="form-group">
						<label for="input4">City</label>
						<input type="text" class="form-control" id="input4" name="city" value="${supp.city}">
					</div>
					<div class="form-group">
						<label for="input5">Postal Code</label>
						<input type="text" class="form-control" id="input5" name="postalCode" value="${supp.postalCode}">
					</div>
					<div class="form-group">
