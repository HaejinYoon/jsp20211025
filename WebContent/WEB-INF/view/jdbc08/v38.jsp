	...
	<div class="container">
		<div class="row">
			...
			<button onclick="topFunction()" id="myBtn" title="Go to top"><i class="fas fa-chevron-up"></i> Top</button>
				<a href="${pageContext.request.contextPath }/jdbc08/s37" class="btn btn-dark sticky-top" style="width:1110px"><i class="fas fa-chevron-left"></i> Back to Add Form</a>
				...
				<table class="table">
					...
					<tr>
						...
						<td>${bean.age }</td>
						<td>${bean.birth }</td>
						<td>${bean.insertDate }</td>
						<td>${bean.modifyDate }</td>
						<%-- <td>${bean.col4 }</td>
						<td>${bean.col5 }</td>
						<td>${bean.col6 }</td>
						<td>${bean.col7 }</td> --%>
						<td>
							<c:url value="/jdbc08/s38rm" var="removeUrl">
						...
						<td>
							<c:url value="/jdbc08/s38modify" var="modifyUrl">
								<c:param name="id" value="${bean.id }"></c:param>
							</c:url>
