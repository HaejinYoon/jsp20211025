...
<body>
			...
			<div class="row">
				<div class="col">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" step="1" name="age">
					</div>
					<div class="form-group">
	...
	<input type="datetime-local" name="col7"> <br> -->
					...
					<a href="${pageContext.request.contextPath }/jdbc08/s38" class="btn btn-secondary"><i class="fas fa-list"></i> Show List</a>
					<br>
				</form>
			</div>
		</div>
