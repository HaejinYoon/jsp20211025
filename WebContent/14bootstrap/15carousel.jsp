	...
	<div class="container">
		<div class="row">
			<div class="col">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt quasi facilis magnam eius qui unde ipsa ipsum illum placeat aperiam aut hic nostrum tempora voluptatum dolores nobis voluptatem. Quidem qui?</p>
	...
	<script>
		$(document).ready(function() {
			$(".myBtn").click(function() {
				...
				$("#carouselExampleIndicators").carousel(number);
			})
		})
	</script>
</body>
